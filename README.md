...
- **预构建工具**: 提供 9 个核心工具，包括文件操作、API 调用、数学计算等
...
- **企业参与**: Anthropic、Meta、PwC、Accenture 等公司参与 Strands Agent SDK 开发
- **开源许可**: Strands Agent SDK 采用 Apache 2.0 许可，支持商业使用
- **生态发展**: 基于开放标准的工具生态系统
